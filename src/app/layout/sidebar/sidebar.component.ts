  ...
  readonly navSections: NavSection[] = [
    {
      ...
      items: [
        ...
        { id: 'checkin', label: 'Check In', icon: 'I', roles: [ROLES.SUPER_ADMIN, ROLES.FRONT_DESK] },
        { id: 'checkout', label: 'Check Out', icon: 'O', roles: [ROLES.SUPER_ADMIN, ROLES.FRONT_DESK] },
    ...
    },
    {
      label: 'Finance',
      items: [
        { id: 'invoices', label: 'Invoices', icon: 'N', roles: [ROLES.SUPER_ADMIN, ROLES.FRONT_DESK, ROLES.ACCOUNT, ROLES.MANAGER] },
        { id: 'payments', label: 'Payments', icon: 'P', roles: [ROLES.SUPER_ADMIN, ROLES.ACCOUNT, ROLES.MANAGER] }
      ]
    },
    {
      label: 'Guests & Staff',
      items: [
        ...
        { id: 'employees', label: 'Employees', icon: 'E', roles: [ROLES.SUPER_ADMIN, ROLES.MANAGER] },
        { id: 'departments', label: 'Departments', icon: 'T', roles: [ROLES.SUPER_ADMIN, ROLES.MANAGER] }
      ]
    },
    {
      label: 'Supply Chain',
      items: [
        { id: 'inventory', label: 'Inventory', icon: 'V', roles: [ROLES.SUPER_ADMIN, ROLES.MANAGER] },
        { id: 'suppliers', label: 'Suppliers', icon: 'L', roles: [ROLES.SUPER_ADMIN, ROLES.MANAGER] },
        { id: 'purchase-orders', label: 'Purchase Orders', icon: 'U', roles: [ROLES.SUPER_ADMIN, ROLES.MANAGER] }
      ]
    },
    {
      label: 'Admin',
      items: [
        ...
        { id: 'reports', label: 'Reports', icon: 'M', roles: [ROLES.SUPER_ADMIN, ROLES.ACCOUNT, ROLES.MANAGER] },
